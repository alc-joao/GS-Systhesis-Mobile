    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Central de comando espacial</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.description}>
            Acesse sua conta para monitorar colônias, missões e sistemas vitais.
          </Text>
          ...
          <View style={[styles.inputGroup, passwordError && styles.inputError]}>
